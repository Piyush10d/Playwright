...
test.skip('test', async ({ page }) => {
  ...
  await page.locator('i1-checkbox i').click();
  await page.locator('i1-checkbox i').click();
  await page.getByRole('link', { name: ' 2 Notification' }).click();
  await page.locator('#searchCodeprocedureContainer').click();
  await page.locator('#searchCodeprocedureContainer').fill('32101');
  await page.locator('#searchCodeprocedureContainer').press('Enter');
  await page.locator('#searchCodeprocedureContainer').fill('');
  await page.getByRole('button', { name: '' }).nth(1).click();
  await page.locator('#newCode').click();
  await page.locator('#codeEditTemplate #dropdownIcon').click();
  await page.getByRole('listitem').filter({ hasText: '1: General (10004 - 10021)' }).locator('i').nth(1).click();
  await page.locator('li:nth-child(5) > .i1-ux-tree-icon').first().click();
  await page.locator('li:nth-child(5) > div > .tree-branch-head').first().click();
  await page.getByRole('listitem').filter({ hasText: ': Respiratory System (30000 - 32999)' }).locator('i').nth(1).click();
  await page.locator('li:nth-child(4) > treeitem > ul > li > .i1-ux-tree-icon > .tree-branch-head').first().click();
  await page.getByRole('listitem').filter({ hasText: '1-029: Skin, subcutaneous and' }).nth(1).click();
  await page.getByText('12001: Simple repair of').click();
  await page.getByRole('button', { name: 'Ok' }).click();
  await page.getByRole('button', { name: 'Main' }).click();
  await page.getByRole('button', { name: 'Apply' }).click();
  await page.getByRole('button', { name: 'Save' }).click();
  await page.getByRole('link', { name: ' 2 Notification' }).click();
  await page.getByText('Error: 1 At least one').click();
  await expect(page.locator('i1-error-bag')).toContainText('Error: 1 At least one category must be marked for Procedure <31000>.');
});
test('test_ new test', async ({ page }) => {
  await page.goto('https://imedengb.rd.dtcs.local/im1ws_imedengb/#/login');
  await page.locator('#userName').click();
  await page.locator('#userName').fill('Rupa');
  await page.locator('#userName').press('Tab');
